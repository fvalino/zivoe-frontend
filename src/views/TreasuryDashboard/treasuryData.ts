...
query {
  rebases(where: {contract: "0x0E642Ffe758aE8ca9703fC3e2A74dC057C8163AD"}, orderBy: timestamp, first: 1000, orderDirection: desc) {
    percentage
    timestamp
  }
}
...
export const tooltipInfoMessages = {
  tvl: "Total Value Deposited, is the dollar amount of all ZVE staked in the protocol. This metric is often used as growth or health indicator in DeFi projects.",
  mvt: "Market Value of Treasury Assets, is the sum of the value (in dollars) of all assets held by the treasury.",
  rfv: "Risk Free Value, is the amount of funds the treasury guarantees to use for backing ZVE.",
  ...
  holder: "Holders, represents the total number of Ohmies (sZVE holders)",
  staked: "ZVE Staked, is the ratio of sZVE to ZVE (staked vs unstaked)",
  ...
  runway: "Runway, is the number of days sZVE emissions can be sustained at a given rate. Lower APY = longer runway",
};
